...
//import com.example.tome.component_base.widget.alertview.AlertView;
//
///**
// * @Created by TOME .
// * @时间 2018/5/17 17:11
...
// */
//
//public abstract class BasePermissionActivity extends BaseMVPActivity implements AdapterView.OnItemClickListener{
//
//    /***照相机权限*/
...
//    public ShowPermissDialog dialog;
//
//    /**判断是否含有当前权限*/
...
//
//
//        dialog = new ShowPermissDialog("权限设置",initView(requestCode),"取消",new String[]{"去设置"},null,this, AlertView.Style.Alert, IFlag.FLAG_SET_PERMISSION,this);
//
//        if (dialog.getIsDismiss()){
//            dialog.show();
//        }
//    }
//
...
//        if(flag ==IFlag.FLAG_SET_PERMISSION&&position==0){
//            //去设置
...
//        String message = "";
//        if (requestCode== BasePermissionActivity.PERMISSION_CAMERA){
//            //照相机权限
//            message = getString(R.string.home_permission_camera);
//        }else if(requestCode == BasePermissionActivity.PERMISSION_PHONE){
//            //电话权限
//            message = getString(R.string.home_permission_phone);
//        }else if(requestCode == BasePermissionActivity.PERMISSION_STORAGE){
//            //文件操作权限
