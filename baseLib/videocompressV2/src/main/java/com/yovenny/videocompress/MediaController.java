...
//        int bitrate = 2 * 921600;//450000;
        int bitrate = 3 * 800 * 480;//450000;
        int rotateRender = 0;
...
//                            outputFormat.setInteger(MediaFormat.KEY_BIT_RATE, bitrate != 0 ? bitrate : 2 * 921600);
                            outputFormat.setInteger(MediaFormat.KEY_BIT_RATE, bitrate != 0 ? bitrate : 3 * 800*480);
                            outputFormat.setInteger(MediaFormat.KEY_FRAME_RATE, 30);//origin 25
                            outputFormat.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, 1);//origin 10
                            if (Build.VERSION.SDK_INT < 18) {
